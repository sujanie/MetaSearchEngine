					...
					<form action="filter.php" method="Post">
							...
							<div class="custom-select">	
									<select type="text" name="price" >
										...
										<option value="0">Select your Price range </option>
										<option value="100">USD 0 to USD 100</option>
										<option value="200">USD 100 to USD 200</option>
										<option value="300">USD 200 to USD 300</option>
										<option value="400">USD 300 to USD 400</option>
										<option value="500">USD 400 to USD 500</option>
									</select>
							</div>
							<button class="booking_form_button mr-lg-auto" name="submit">Proceed</button>
